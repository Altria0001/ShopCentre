...
public class MqConstant {
    ...
    public static final String PRODDUCT_ADD_QUEUE="product_add_queue";
    public static final String PRODDUCT_UPDATE_QUEUE="product_update_queue";
    public static final String PRODDUCT_EXCHANGE="product_exchange";
